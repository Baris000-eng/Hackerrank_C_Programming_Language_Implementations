...
//Task
//Y//our task is to take two numbers of int data type, two numbers of float data type as input and output their sum:
...
//When we sum the floating-point numbers  and , we get . When we subtract the //second number  from the first number , we get  as their difference.
    ...
    float secondSum = var1 + var2;
    printf("\n%.1f ",secondSum);
    
    float secondSubstr = var1 - var2;
    printf("%.1f", secondSubstr);
